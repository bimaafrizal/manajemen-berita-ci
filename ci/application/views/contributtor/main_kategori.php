            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md">
                        ...
                        ?>
                            <div class="row mb-3">
                                <div class="col-2 themed-grid-col"> <?php echo $data->id_kategori; ?> </div>
                                <div class="col-2 themed-grid-col"> <?php echo $data->nama_kategori; ?> </div>
                                <div class="col-2 themed-grid-col">
                                    <a class="btn btn-warning" href="<?= base_url('manage_contributor_18/edit_user/' . $data->id_kategori) ?>" role="button">Edit</a>
                                    <a class="btn btn-danger" href="<?= base_url('manage_contributor_18/hapus_user/' . $data->id_kategori) ?>" role="button">Hapus</a>
                                </div>
                            </div>
